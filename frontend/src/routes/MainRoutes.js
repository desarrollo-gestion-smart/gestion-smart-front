...
/// WhatsApp Routes
const WhatsappTemplatesMessages = Loadable(lazy(() => import('views/whatsapp/template-messages/templateMessages')));
const ValidateNumber = Loadable(lazy(() => import('views/whatsapp/template-messages/validateNumber')));
const ValidateCode = Loadable (lazy(() => import ('views/whatsapp/template-messages/validateCode')))
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/whatsapp',
            element: <WhatsappTemplatesMessages />
        },
        {
            path: '/whatsapp/validation',
            element: <ValidateNumber />
        },
        {
            path: '/whatsapp/verificationCode',
            element: <ValidateCode />
        },
        {
            path: 'apps/wallet/vinculate',
            element: <WalletVinculate />
        },
        {
            path: 'apps/wallet/transactions',
