    ...
    useEffect(() => {
        navigation?.items?.map((menu) => {
            if (menu.type && menu.type === 'group') {
                if (menu?.url && process.env.REACT_APP_BASE_NAME + menu.url === document.location.pathname) {
                    setMain(menu);
                    setItem(menu);
                } else {
                    getCollapse(menu);
                    ...
                    <Box sx={{ p: 2, pl: card === false ? 0 : 2 }}>
                        ...
                        >
                            ...
                            <Grid item>
                                ...
                                >
                                    <Typography component={Link} to="/dashboard/default" color="inherit" variant="subtitle1" sx={linkSX} aria-label="home">
